...
{
	static GLfloat lineVertices[2][2];
	lineVertices[0][0] = ((2.0f * sx) / WIDTH) - 1.0f;;
	lineVertices[0][1] = 1.0f - ((2.0f * sy) / HEIGHT);;
	lineVertices[1][0] = ((2.0f * ex) / WIDTH) - 1.0f;;
	lineVertices[1][1] = 1.0f - ((2.0f * ey) / HEIGHT);;
